...
tmux split-window -h -t ribeit-api -c /Users/mac/dev/ribeit-api
...
tmux split-window -h -t ribeit-ui -c /Users/mac/dev/ribeit-ui
...
tmux split-window -h -t spro-app -c /Users/mac/dev/spro-app
...
tmux split-window -h -t spro-wordpress -c /Users/mac/dev/spro-wordpress
tmux select-pane -t spro-wordpress:1.0

# spro-marketing
tmux new-session -d -s spro-marketing -c /Users/mac/dev/spro-marketing
tmux split-window -h -t spro-marketing -c /Users/mac/dev/spro-marketing
