...
// Local preset: short animation, moderate stretch, and one-cell movement.
...
const float TRAIL_SIZE = 0.45; // 0.0 = all corners move together. 1.0 = max smear (leading corners jump instantly)
const float THRESHOLD_MIN_DISTANCE = 0.25; // min distance to show trail (units of cursor height)
